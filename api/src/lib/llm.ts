...
const SYSTEM_PROMPT =
  "Analyze the tweet. Respond JSON: { ai_probability: 0-1, category: 'normal' | 'engagement_farming' | 'ragebait' | 'hate_speech', reason: string }. 'engagement_farming': explicit requests for likes/retweets/replies. 'ragebait': intentionally provocative to cause anger. 'hate_speech': attacks on protected group.";
